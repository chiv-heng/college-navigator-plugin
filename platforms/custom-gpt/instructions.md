...
> Manually adapted from the Claude plugin in `skills/college-navigator/` and
> its references. This adapter uses a single-model, multi-perspective workflow
> instead of true runtime subagents.
